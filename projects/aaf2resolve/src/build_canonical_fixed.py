...
def extract_keyframe_timing_data(param):
    ...
    - Parameters are VaryingValue objects directly, not wrappers with .value
    - Use type(param).__name__ == 'VaryingValue' for detection
    - Access PointList via param.get('PointList')
    """
    # ChatGPT's key fix: Check parameter type directly
